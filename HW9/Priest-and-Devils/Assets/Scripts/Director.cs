...
namespace Com.Mygame {
	...
	public class CoastController {
        ...
        public MyCharacterController FindCharacterOnTheCoast(int passenger_name)
        {   // 0->priest, 1->devil
            for (int i = 0; i < passengerPlaner.Length; i++)
            {
                if (passengerPlaner[i] != null && passengerPlaner[i].getType() == passenger_name)
                {
                    MyCharacterController charactorCtrl = passengerPlaner[i];
                    return charactorCtrl;
                }
	...
	public class BoatController {
        ...
        public MyCharacterController[] GetPassengerOnTheBoat()
        {
            return passenger;
        }
	}
